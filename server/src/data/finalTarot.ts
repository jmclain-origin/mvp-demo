...
const deck: Tarot[] = [
    ...
    {
        fortune_telling: ['Victory is a certainty', 'Move ahead with all plans', 'Beware the jealousy of others'],
    ...
    {
        fortune_telling: ["Someone's using drugs or alcohol to excess", "It's time to get back on that diet"],
    ...
    {
        fortune_telling: ["You'll be planning a trip soon", 'Be on the lookout: your ship is coming in'],
    ...
    {
        fortune_telling: ['Someone is watching and evaluating your work', 'You may get a wedding invitation soon'],
    ...
    {
        fortune_telling: ["Don't be surprised by a personal attack", 'Prepare to defend yourself or someone you love'],
    ...
    {
        fortune_telling: ['Someone has a secret crush on you', 'Relationships should be mutual; get rid of a leech'],
    ...
    {
        fortune_telling: ['A breakup looms', "Don't cry over spilt milk", 'Take your lumps and get back in the saddle'],
    ...
    {
        fortune_telling: ['Marriage and family are in the cards', 'Expect a friendship to blossom into a romance'],
    ...
    {
        fortune_telling: ['The time to make a choice is now', 'Stop wavering and do what you know is best'],
    ...
    {
        fortune_telling: ["Don't make any decision now", "Wait, and you'll be glad you did"],
    ...
    {
        fortune_telling: ["If you take the action you're considering now, you'll be sorry in the future"],
    ...
    {
        fortune_telling: ['Disaster', 'Put off plans and do not take action until omens are better'],
    ...
    {
        fortune_telling: ['Your health will improve', "The check you're looking for really is in the mail"],
    ...
    {
        fortune_telling: ['A high-dollar contract is in your future', "If you work hard, you'll succeed"],
    ...
    {
        fortune_telling: ["Things won't work out as expected", 'Pick up the pieces and prepare to move on'],
    ...
    {
        fortune_telling: ['Stop over-analyzing, researching, and outlining', 'Buckle down and get the work done'],
    ...
    {
        fortune_telling: ["Until you appreciate what you have, you won't have any luck getting more"],
    ...
    {
        fortune_telling: ['Big money is in the near future', 'Expect a powerful blessing to come your way'],
